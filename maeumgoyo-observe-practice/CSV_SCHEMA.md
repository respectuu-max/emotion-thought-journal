...
- 화면 표시명: v90부터 `behavior_areas`/`behavior_custom_areas`는 화면에서 "경험한 문제"로 표시될 수 있습니다. 여기서 경험한 문제란 스트레스, 부정적 감정, 반복되는 생각, 몸반응, 충동, 회피, 관계 갈등, 중독행동 또는 문제행동을 포함합니다. CSV 필드명은 하위 호환을 위해 그대로 유지합니다.
